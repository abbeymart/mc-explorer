<template>
  <div>
        ...
        <div class="mc-explorer-right-box" id="mc-explorer-table">
          ...
          <div v-if="subItems.length > 0">
            <div class="w3-container">
              <div class="w3-half w3-left" id="mc-explorer-message">
                <McExplorerPageLimit/>
              </div>
              <div class="w3-half w3-right" id="mc-explorer-search">
                <McExplorerSearch/>
              </div>
            </div>
            <McExplorerTable/>
    ...
    <div v-else>
      <McExplorerNoData :no-data-message="invalidDataMessage" :loading-data-message="loadingDataMessage"
                        :items-count="dataItems.length"/>
    </div>
  </div>
</template>
...
// sub-components
import McExplorerTable from "./McExplorerTable.vue";
import McExplorerSearch from "./McExplorerSearch.vue";
...
import McExplorerPageLimit from "./McExplorerPageLimit.vue";
...
const validData = computed<boolean>(() => {
  ...
  return !!mainDataField && !!sourceItemField && !!targetItemField && dataItemFields.includes(targetItemField) &&
      categoryItemFields.includes(mainDataField) && categoryItemFields.includes(sourceItemField) && recordTotal.value > 0
})
